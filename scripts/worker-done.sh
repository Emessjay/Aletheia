...
# match aletheia-<slug>). Refuses if no commits ahead of main — this
...
osascript -e "display notification \"$slug: $summary\" with title \"Aletheia worker done\"" 2>/dev/null || true
